#!/usr/bin/env python3
"""
Cheapest Watches - 1688 Product Finder
Finds cheapest products on 1688 with 90%+ similarity using image search and AI comparison
"""
...
def process_products_parallel(model, reference_image, products):
    """Process all products in parallel and return the cheapest one with 90%+ similarity"""
    ...
    if high_similarity_products:
        ...
        for product, score in high_similarity_products:
            # Try to extract numeric price from text like "¥44" or "¥10.5"
...
def main():
    """Main function"""
    print("🔍 Cheapest Watches - 1688 Product Finder (90%+ similarity)")
    print("=" * 50)
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                if best_product and best_score is not None:
                    ...
                    print(f"❌ Could not find a match with 90%+ similarity for this URL")
